...
class Chromosome:
    def __init__(self, problParam=None):
        ...
        self.__repres = firstGen(problParam['net'])
    ...
    def crossover(self, c):
        ...
        offspring.__repres = [self.__repres[i] if i < cuttingPoint else c.__repres[i] for i in
                              range(self.__problParam['noDiffChars'])]
        return offspring
